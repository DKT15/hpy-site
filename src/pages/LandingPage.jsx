...
import { BookOpen, CircleHelp, Landmark } from "lucide-react";
          ...
          <section className="hero" aria-labelledby="hero-heading">
            <div className="container hero-grid">
              <div className="hero-content">
                <p className="eyebrow">Explore the past</p>

                <h1 id="hero-heading">
                  History made <span className="accent-text">engaging.</span>
                </h1>

                <p className="hero-tagline">Learn something new every day.</p>

                <p className="hero-description">
                  Discover fascinating stories, test your knowledge and explore
                  history through engaging content delivered straight to your
                  inbox.
                </p>
              ...
              <div className="hero-art" aria-hidden="true">
                <img src="/hero-art.webp" alt="" className="hero-art-image" />
              </div>
            </div>
          </section>
